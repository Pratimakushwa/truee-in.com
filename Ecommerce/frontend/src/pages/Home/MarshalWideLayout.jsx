...
//   return (
//     <div className="w-full bg-white flex flex-col items-center justify-center py-6 px-3 sm:px-4 md:px-6 font-sans">
...
//               <h3 className="text-white text-[24px] xs:text-[28px] sm:text-[32px] md:text-[34px] font-serif font-bold leading-[1.1] mb-3 whitespace-pre-line">
//                 {banner.title}
//               </h3>
...
//           </p>
//           <h3 className="text-2xl sm:text-3xl md:text-[32px] font-serif font-bold text-black mb-3">
//             Unboxing &amp; Review
//           </h3>
...
const MarshallWideLayout = () => {
  ...
  return (
    <div 
      ...
      style={{ fontFamily: "'Inter', sans-serif" }} // ⚡ Inter font applied globally here
    >
        ...
        {heroBanners.map((banner, idx) => (
          ...
          >
            ...
            <div className="absolute inset-y-0 left-0 flex flex-col justify-center px-5 sm:px-7 md:px-8 z-10 max-w-[80%]">
              ...
              {/* ⚡ Cormorant Garamond applied to Banner Titles */}
              <h3 
                className="text-white text-[24px] xs:text-[28px] sm:text-[32px] md:text-[34px] leading-[1.1] mb-3 whitespace-pre-line"
      ...
      <section className="w-full max-w-[1400px] mx-auto mt-14  mb-2 relative group">
        <div className="text-center mb-6 sm:mb-8">
          ...
          {/* ⚡ Cormorant Garamond applied to Section Heading */}
          <h3 
