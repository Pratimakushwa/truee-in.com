...
//   return (
//     <section className="w-full bg-white py-8 px-4 md:px-12 border-t border-gray-100 group relative">
...
//           {/* Nav arrows: desktop/tablet only — mobile users swipe directly on the cards */}
//           <button
//             type="button"
//             className="swiper-button-prev-custom hidden sm:flex absolute top-[45%] -left-1 z-20 w-10 h-10 rounded-full bg-white shadow-lg border border-gray-100 items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-gray-700 hover:text-[#C8A253] cursor-pointer"
//             aria-label="Previous"
//           >
//             &#8249;
//           </button>
//           <button
//             type="button"
//             className="swiper-button-next-custom hidden sm:flex absolute top-[45%] -right-1 z-20 w-10 h-10 rounded-full bg-white shadow-lg border border-gray-100 items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-gray-700 hover:text-[#C8A253] cursor-pointer"
//             aria-label="Next"
//           >
//             &#8250;
//           </button>
