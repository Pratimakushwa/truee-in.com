...
export default function HomeAmazonBlocks({ products }) {
  ...
  return (
    <div className="w-full bg-white py-6  px-4 sm:px-6 md:px-8 relative">
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-[32px] font-serif font-bold text-[#1a1a1a] mb-2">Recommended For You</h2>
