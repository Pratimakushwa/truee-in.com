...
// import React, { useEffect, useState } from "react";
// import { createPortal } from "react-dom";
// import { Minus, Plus, Trash2, X, ShoppingBag, Gift, CheckCircle2 } from "lucide-react"; // ⚡ ADDED Gift and CheckCircle2 icons
// import axiosInstance from "../utils/axiosInstance";
// import { useNavigate } from "react-router-dom";
// import Toast from "../components/Toast";
...
//   // ⚡ MAGIC CALCULATION: Check gap for 3000
//   const minThreshold = 3000;
//   const amountNeeded = minThreshold - subtotal;
...
//             {/* ⚡ STEP 3 LOGIC: MOTIVATION BANNER */}
//             <div className="mb-5">
//                 {amountNeeded > 0 ? (
//                     <div className="bg-[#fdf9ef] border border-[#C8A253]/30 p-3 rounded flex gap-3 items-center shadow-sm">
//                         <Gift className="text-[#C8A253] shrink-0" size={20} />
//                         <p className="text-sm font-medium text-gray-700 leading-tight">
//                             Add items worth <span className="font-bold text-black">₹{amountNeeded.toLocaleString('en-IN')}</span> more to unlock flat <span className="font-bold text-[#C8A253]">₹500 OFF</span>! Use code <b>WELCOME500</b>
//                         </p>
//                     </div>
//                 ) : (
//                     <div className="bg-green-50 border border-green-200 p-3 rounded flex gap-3 items-center shadow-sm">
//                         <CheckCircle2 className="text-green-600 shrink-0" size={20} />
//                         <p className="text-sm font-medium text-green-800 leading-tight">
//                             Yay! 🎉 You are eligible to use <b className="text-black">WELCOME500</b> at checkout!
//                         </p>
//                     </div>
//                 )}
//             </div>
//             {/* ⚡ END OF MOTIVATION BANNER */}
...
// import React, { useEffect, useState } from "react";
// import { createPortal } from "react-dom";
// import { Minus, Plus, Trash2, X, ShoppingBag, Gift, CheckCircle2 } from "lucide-react"; 
// import axiosInstance from "../utils/axiosInstance";
// import { useNavigate } from "react-router-dom";
// import Toast from "../components/Toast";
...
//   const [loading, setLoading] = useState(true);
//   const [toastMessage, setToastMessage] = useState(null);
//   const [hasValidCoupon, setHasValidCoupon] = useState(false); // ⚡ NAYA STATE: Coupon check karne ke liye
//   const navigate = useNavigate();

//   const showToast = (type, message) => setToastMessage({ type, message });

//   // ⚡ NAYA FUNCTION: Backend se real coupon status check karega
//   const fetchCouponStatus = async () => {
//     try {
//       const { data } = await axiosInstance.get('/auth/profile');
//       if (data?.user?.coupons) {
//         // Check karo ki WELCOME500 hai aur 'Available' hai ya nahi
//         const welcomeCoupon = data.user.coupons.find(c => c.code === 'WELCOME500');
//         if (welcomeCoupon && welcomeCoupon.status === 'Available') {
...
//       setLoading(true);
//       fetchCart();
//       fetchCouponStatus(); // ⚡ Cart khulte hi coupon status check hoga
//     }
//   }, [isOpen]);
...
//             {/* ⚡ Yahan Nayi condition add ki gayi hai ki banner tabhi dikhao jab coupon available ho */}
//             {hasValidCoupon && (
//               <div className="mb-5">
//                   {amountNeeded > 0 ? (
//                       <div className="bg-[#fdf9ef] border border-[#C8A253]/30 p-3 rounded flex gap-3 items-center shadow-sm">
...
export default function Cart({ isOpen, onClose }) {
  ...
  useEffect(() => {
    if (isOpen) {
      setLoading(true);
      fetchCart();
      fetchCouponsAndProfile(); // ⚡ Dynamic coupons load karo
    }
  }, [isOpen]);
