...
//           <div className="max-w-4xl mx-auto px-6 text-center">
//             <div className="flex justify-center gap-1 mb-4 md:mb-6 text-[#C8A253]">
//               {[1, 2, 3, 4, 5].map((i) => (<Star key={i} fill="currentColor" size={16} className="md:w-[18px] md:h-[18px]" />))}
//             </div>
            
//             <h2 className="text-3xl md:text-7xl font-medium tracking-tighter mb-4 md:mb-6 leading-tight capitalize">
//               {fullProduct?.brand ? `${fullProduct.brand} Signature .` : "Premium Signature ."}
//             </h2>            
//             <p className="text-[9px] md:text-[11px] font-bold uppercase tracking-[0.25em] text-gray-500 mb-10 md:mb-16">
//               {fullProduct?.reviewsCount || "843"} Verified Audiophiles &nbsp;•&nbsp; 4.9 Rating
//             </p>
            
//             {/* ⚡ YAHAN FIX KIYA HAI: Mobile ke liye grid-cols-1 ko hata kar grid-cols-3 kar diya aur gap-3 kiya */}
//             <div className="grid grid-cols-3 gap-3 md:gap-10 pb-8 md:pb-12 px-2 md:px-0">
//               {galleryImages.slice(0, 3).map((img, i) => (
//                 <div 
//                   key={i} 
//                   // ⚡ Mobile ke liye corner 'rounded-xl' aur padding 'p-2' choti kar di hai
//                   className={`aspect-square w-full rounded-xl md:rounded-[2rem] bg-gray-50 overflow-hidden shadow-sm border border-gray-100 group transition-transform duration-500 flex items-center justify-center p-2 md:p-6 ${
//                     i === 1 ? 'translate-y-3 md:translate-y-16' : '' 
//                   }`}
//                 >
//                   <img 
//                     src={img} 
