...
// import React, { useState, useEffect } from 'react';
// import { useParams, Link } from 'react-router-dom';
// // ⚡ Truck icon import add kiya
// import { Star, X, Truck } from 'lucide-react';
// import axiosInstance from '../utils/axiosInstance';
// import Toast from '../components/Toast';
// import { CUSTOMER_TIMELINE, getTimelineIndex } from '../constants/orderStatuses';
...
//       setIsModalOpen(false); 
//       alert("🚨 SYSTEM MESSAGE: " + errorMessage); 
...
//                 <h3 className="text-lg font-serif">Tracking Details</h3>
//               </div>
//               
//               {order.trackingDetails && order.trackingDetails.awbNumber ? (
//                 <div className="space-y-4">
//                   <div>
//                     <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Courier Partner</p>
//                     <p className="font-medium text-gray-900">
//                       {order.trackingDetails.courierPartner || 'Assigned Courier'}
//                     </p>
//                   </div>
//                   <div>
//                     <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Tracking Number (AWB)</p>
//                     <div className="inline-block mt-1">
//                       <span className="font-mono text-sm text-[#C8A253] bg-[#C8A253]/10 border border-[#C8A253]/20 py-1.5 px-3 rounded-lg font-semibold">
//                         {order.trackingDetails.awbNumber}
//                       </span>
//                     </div>
//                   </div>
//                   {order.trackingDetails.shippedAt && (
//                     <div>
//                       <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Shipped On</p>
//                       <p className="text-sm text-gray-800">
//                         {new Date(order.trackingDetails.shippedAt).toLocaleDateString('en-IN', { 
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 py-12 px-4 md:px-8 font-sans">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {/* Main Grid: Items and Delivery Address */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Delivery Address Section (Right Side) */}
          <div className="space-y-8">
        ...
        {/* ⚡ NEW HORIZONTAL TRACKING DETAILS SECTION (At the Bottom) */}
        <div className="mt-8 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-6 border-b border-gray-100 pb-4">
            <Truck className="w-5 h-5 text-gray-700" />
            <h3 className="text-lg font-serif text-gray-900">Tracking Information</h3>
          </div>
          ...
          {order.trackingDetails && order.trackingDetails.awbNumber ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Courier Partner</p>
              ...
              {/* AWB Box */}
              <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Tracking Number (AWB)</p>
                <div className="inline-block">
                  <span className="font-mono text-base text-[#C8A253] bg-[#C8A253]/10 border border-[#C8A253]/20 py-1.5 px-4 rounded-lg font-semibold tracking-wide">
                    {order.trackingDetails.awbNumber}
                  </span>
                </div>
              </div>
              ...
              {/* Date Box */}
              <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Shipped On</p>
                <p className="text-lg font-medium text-gray-900">
                  {order.trackingDetails.shippedAt ? new Date(order.trackingDetails.shippedAt).toLocaleDateString('en-IN', { 
                    day: 'numeric', month: 'short', year: 'numeric' 
                  }) : 'Updating...'}
                </p>
              </div>
        ...
        {/* End of Horizontal Tracking Details */}
